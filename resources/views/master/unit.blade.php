                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('unit')}}">Unit</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-primary">
                                            <h5 class="text-light">List Unit</h5>
                                            {{-- <div class="card-header-right"> --}}

                                                    <button class="btn btn-warning float-right" style="@if($user->hasPermission('add_unit')!=true){{'display:none;'}}@endif" data-toggle="modal" data-target="#mdl_add"><span class="fa fa-plus text-light"></span></button>
                                            {{-- </div> --}}
                                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-primary">
                                  <h5 class="modal-title text-light" id="exampleModalLabel">Tambah Unit</h5>
                                    ...
                                    <div class="card-block">
                                        <form id="fsave" method="post">
                                            <div class="form-group form-primary">
                                                <label class="float-label">Kode Unit </label>
                                                <input type="text" name="kd_unit" id="kd_unit" class="form-control" required>
...
<script>
    ...
    function save_role(id_user,role_id){
        ...
        $.ajax({
            ...
            data: {_token:CSRF_TOKEN,id_user:id_user,role_id:role_id},
